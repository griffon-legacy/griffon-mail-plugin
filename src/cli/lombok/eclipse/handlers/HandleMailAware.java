 ...
 */
public class HandleMailAware extends EclipseAnnotationHandler<MailAware> {
    ...
    public void handle(AnnotationValues<MailAware> annotation, Annotation source, EclipseNode annotationNode) {
        ...
        EclipseUtil.addInterface(type.get(), MailAwareConstants.MAIL_CONTRIBUTION_HANDLER_TYPE, source);
    ...
    private static class EclipseMailAwareHandler extends MailAwareHandler<EclipseType> {
    }
}
